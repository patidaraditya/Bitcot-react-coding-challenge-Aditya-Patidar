  ...
  return (
    <>
      ...
      <div className="heading">
        <h2 className="title"> Popular title</h2>
      </div>
      <div className="fistpagecontent">
        <div className="series">
          <Link className="Serieslink" to="/Series">
            <img src={placeholder} className="movie-icon" alt="" />
            Series
          </Link>
        </div>
        <div className="movie">
          <Link className="Serieslink" to="/Movies">
            <img src={placeholder} className="movie-icon" alt="" />
            Movies
          </Link>
        </div>
